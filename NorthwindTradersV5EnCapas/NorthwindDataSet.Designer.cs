    ...
    public partial class NorthwindDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public byte[] RowVersion {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'RowVersion\' de la tabla \'Employees\' es DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsRowVersionNull() {
                return this.IsNull(this.tableEmployees.RowVersionColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetRowVersionNull() {
                this[this.tableEmployees.RowVersionColumn] = global::System.Convert.DBNull;
            }
...
namespace NorthwindTradersV5EnCapas.NorthwindDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ((" +
                "@IsNull_RowVersion = 1 AND [RowVersion] IS NULL) OR ([RowVersion] = @Original_Ro" +
                "wVersion)))";
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath, RowVersion FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [Title] = @Title, [TitleOfCourtesy] = @TitleOfCourtesy, [BirthDate] = @BirthDate, [HireDate] = @HireDate, [Address] = @Address, [City] = @City, [Region] = @Region, [PostalCode] = @PostalCode, [Country] = @Country, [HomePhone] = @HomePhone, [Extension] = @Extension, [Photo] = @Photo, [Notes] = @Notes, [ReportsTo] = @ReportsTo, [PhotoPath] = @PhotoPath WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@IsNull_RowVersion = 1 AND [RowVersion] IS NULL) OR ([RowVersion] = @Original_RowVersion)));
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath, RowVersion FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NorthwindTradersV5EnCapas.Properties.Settings.Default.Northwind2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDa" +
                ...
                "es, ReportsTo, PhotoPath, RowVersion FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_EmployeeID, byte[] Original_RowVersion) {
        ...
        public virtual int Update(
            ...
            if ((Original_RowVersion == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((byte[])(Original_RowVersion));
            }
        ...
        public virtual int Update(
                    ...
                    int Original_EmployeeID, 
                    byte[] Original_RowVersion) {
            return this.Update(LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath, Original_EmployeeID, Original_RowVersion, Original_EmployeeID);
        }
    }
